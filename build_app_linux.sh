...
JAVA_VERSION=17
MAIN_JAR="BetAndRuin22-$PROJECT_VERSION.jar"
...
detected_modules=`$JAVA_HOME/bin/jdeps \
  ...
  --class-path "target/installer/input/libs/*" \
    target/classes/ui/ApplicationLauncher.class`
...
manual_modules=,jdk.crypto.ec,jdk.localedata,java.xml,java.scripting,jdk.unsupported,java.naming,java.desktop,java.management,java.sql
...
--name BetAndRuin22 \
--main-class ui.ApplicationLauncher \
--main-jar ${MAIN_JAR} \
--java-options -Xmx2048m \
--runtime-image target/java-runtime \
--icon src/main/resources/icon/favicon.ico \
--app-version ${APP_VERSION} \
--vendor "UPV/EHU" \
--copyright "Copyright © 2021-22 Josefinators"
