    ...
    public class DataAccess {
        ...
        public void initializeDB(){
            ...
            try {
                ...
                User user1 = new User("user1", "Marcelo", "Vázquez González", new SimpleDateFormat("yyyy-MM-dd").parse("1990-02-02"), "P. Sherman street Wallaby 42 Sydney", "betandruin22@gmail.com", "1.jpg", password, salt, 1, 0D);
                User admin1 = new User("admin1", "Chema", "Alonso", new SimpleDateFormat("yyyy-MM-dd").parse("1980-02-02"), "adminAddress", "chemaAl0ns0234@email.com", "2.jpg", password, salt, 2, 0D);
